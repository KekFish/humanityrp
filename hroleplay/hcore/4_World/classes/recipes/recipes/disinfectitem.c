...
{	
	...
	override bool CanDo(ItemBase ingredients[], PlayerBase player)//final check for recipe's validity
	{
		...
		if (ingredient1.IsKindOf("Vodka") && ingredient1.GetLiquidType() == 2048)
        {

            if ( ingredient1.IsKindOf("Vodka") && ingredient1.GetQuantity() != ingredient1.GetQuantityMax())
			{
