class CraftLeatherSewing extends RecipeBase	
{
	override void Init()
	{
		m_Name = "Wytwórz Zestaw do naprawy Skóry";
		...
		//ingredient 2
		InsertIngredient(1,"Pelt_Base");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("LeatherSewingKit");//add results here
