...
{
	const float INFLUENZA_AGENT_AUTOINFECT_THRESHOLD_HC = PlayerConstants.THRESHOLD_HEAT_COMFORT_MINUS_CRITICAL;
	...
	override void Init()
	{
		...
		m_AutoinfectProbability = CalculateAutoinfectProbability( 0.20 );
