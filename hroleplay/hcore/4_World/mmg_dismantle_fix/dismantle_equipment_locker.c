...
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"mmg_equipment_locker_green");//you can insert multiple ingredients this way
		...
		InsertIngredient(1,"Lockpick");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("mmg_equipment_locker_green_kit");//add results here
