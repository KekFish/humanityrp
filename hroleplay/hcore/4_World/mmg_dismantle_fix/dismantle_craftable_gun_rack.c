...
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"mmg_craftable_gun_rack");//you can insert multiple ingredients this way
		...
		m_ResultSetQuantity[1] = 25;//-1 = do nothing
		...
		m_ResultReplacesIngredient[1] = -1;// value == -1 means do nothing; a value >= 0 means this result will tra
