...
const string LOADING_SCREENS_PATH 	= "hroleplay/hgui/Data/LoadingImages.json";
const string LOADING_MESSAGES_PATH 	= "hroleplay/hgui/Data/LoadingMessages.json";
const string LOADING_SCREEN_LOGO 	= "hroleplay/hgui/layouts/Pictures/full_alpha.edds";
									//! ModName/Path/File
